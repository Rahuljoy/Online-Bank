...
$transactiontempquery = "INSERT INTO transaction_temps SET from_account=:from_account,to_mobile_no=:to_mobile_no,from_mobile_no=:from_mobile_no,transactions_amount=:transactions_amount,transaction_status='Pending',transaction_type='Mobile Recharge'";
...
//transaction
    $transactionquery = "INSERT INTO transactions SET from_account=:from_account,to_mobile_no=:to_mobile_no,from_mobile_no=:from_mobile_no,transactions_amount=:transactions_amount,transaction_status='Successfully',transaction_type='Mobile Recharge'";
