                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="active"><a href="/D_bank/login.php">Log In<br/><small>User</small></a></li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="row">
                <div style="text-align: center;">
                    <div class="row">
                        ...
                        <br/>
                        <div class="col-md-3">
                            <a href="userCardInformation.php">
                                <button type="button" class="btn btn-primary">Card Information</button>
                            </a>
                        </div>
                        <br/>
                        <div class="col-md-3">
                            <a href="userBalance.php">
                                <button type="button" class="btn btn-primary">User Balance</button>
                            </a>
                        </div>
                        <br/>
                        <div class="col-md-3">
                            <a href="transactionHistory.php">
                                <button type="button" class="btn btn-primary">Transaction History</button>
                            </a>
                        </div>
                        <br/>
                    </div>
