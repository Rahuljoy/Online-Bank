            ...
            <div class="col-md-10">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <a href="userDetailsView.php?UserId="> <button type="button" class="btn btn-info">User Details</button></a>
                            <a href="createCard.php?UserId="><button type="button" class="btn btn-primary">Create Card</button></a>
                            <a href="transactionLogView.php?UserId="><button type="button" class="btn btn-warning">Transaction</button></a>
