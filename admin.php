                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="active"><a href="/D_bank/login.php">Log In<br/><small>Admin</small></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a href="userManagement.php">
                                <button type="button" class="btn btn-primary">User Management</button>
                            </a>
                        </div>
                        <div class="col-md-6">
                            <a href="accountApprove.php">
                                <button type="button" class="btn btn-primary">Account Approve</button>
                            </a>
                        </div>
                    </div>
                </div>
