...
<div class="container" style="width:1880px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="active"><a href="/D_bank/login.php">Log In<br/><small>Admin</small><small>(Account Approve)</small></a></li>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="row">
        ...
        <div class="row">
            <div style="text-align: center">
            <h3>............User Account Management Approve System ..............</h3>
            </div>
        </div>
    </div>
    <br/>
                    ...
                    <div class="col-md-8">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><a href="accountApproveView.php?UserId="> <button type="button" class="btn btn-info">View</button> </a>
